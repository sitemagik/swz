    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a sweet address (e.g. VTHZfUg11wEJmSgBLUcmCKGYekuqFcGHQq)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a sweet address (e.g. VTHZfUg11wEJmSgBLUcmCKGYekuqFcGHQq)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter sweet signature"));
#endif
